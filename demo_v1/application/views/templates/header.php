...
<head>
    ...
    <script src="<?php echo base_url('public/products/vendor/jquery/jquery.min.js');?>"></script>
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <li class="nav-item">
                            ...
                            <a id="shopping-cart" class="nav-link waves-effect waves-dark" href="<?php echo base_url('business/show_shopping_list');?>" aria-haspopup="true" aria-expanded="false"> <i class="fas fa-shopping-cart font-24"></i><span id="total-item" class="badge badge-bill badge-danger"><?php if(!empty($numItems)){echo $numItems;} else{echo 0;} ?></span></a>
                            <?php endif;?>
                        </li>
                        <!-- ==========================End Shopping Card========================= -->
                        <!-- Comment -->
