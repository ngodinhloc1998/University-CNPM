...
<head>
	...
	<!-- ICONS -->
	<link rel="apple-touch-icon" sizes="76x76" href="<?php echo base_url('template/template/assets/img/apple-icon.png');?>">
	<link rel="icon" type="image/png" sizes="96x96" href="<?php echo base_url('template/template/assets/img/favicon.png');?>">
</head>
				...
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							...
							<form class="form-auth-small" method="POST" action="<?php echo base_url('users/login');?>">
								...
								<div class="form-group">
									...
									<input type="password" name="password" class="form-control" id="signin-password" value="<?php?>" placeholder="Password">
								</div>
