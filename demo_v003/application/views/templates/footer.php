            ...
            <footer class="footer text-center">
                <h6>Kofi Kai Coffee &copy; 2018</h6>
            </footer>
            <!-- ============================================================== -->
            <!-- End footer -->
            <!-- ============================================================== -->
    ...
    <script src="<?php echo base_url('public/products/vendor/bootstrap/js/bootstrap.bundle.min.js');?>"></script>
    ...
    <script src="<?php echo base_url('public/assets/libs/magnific-popup/dist/jquery.magnific-popup.min.js');?>"></script>
    <script src="<?php echo base_url('public/assets/libs/magnific-popup/meg.init.js');?>"></script>
    <script src="<?php echo base_url('public/chart/canvasjs.min.js'); ?>"></script>
