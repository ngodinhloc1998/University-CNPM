...
<body>
    <form class="form-group" action="<?php echo base_url('users/login');?>" method="POST">
        ...
        <input class="form-control" type="submit" name="submit" value="submit" <?php echo isset($_POST['password']) ? $_POST['password'] : ''; ?>>
    </form>
