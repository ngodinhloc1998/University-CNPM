            ...
            <nav class="navbar top-navbar navbar-expand-md navbar-dark">
                ...
                <div class="navbar-collapse collapse" id="navbarSupportedContent" data-navbarbg="skin5">
                    ...
                    <ul class="navbar-nav float-right">
                        ...
                        <!-- Shopping Card -->
                        <li class="nav-item">
                            <?php if(isset($_SESSION['id_table']) && isset($numItems)): ?>
                            <a class="nav-link waves-effect waves-dark" href="#" aria-haspopup="true" aria-expanded="false"> <i class="fas fa-shopping-cart font-24"></i><span id="total-item" class="badge badge-bill badge-danger"><?php echo $numItems; ?></span></a>
                            <?php endif;?>
                        </li>
                        <!-- ==========================End Shopping Card========================= -->
                        <!-- Comment -->
